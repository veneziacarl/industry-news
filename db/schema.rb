...
ActiveRecord::Schema.define(version: 20160328164319) do
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.boolean  "daily_news",  default: true, null: false
    t.boolean  "weekly_news", default: true, null: false
  end
  ...
  create_table "newsletter_articles", force: :cascade do |t|
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.string   "send_article",  default: "false", null: false
  end
